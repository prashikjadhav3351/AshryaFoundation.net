...
if (!empty($profile_picture) && file_exists($profile_picture)) {
    $pdf->Image($profile_picture, 170, 50, 30, 0); // Adjust x, y, width, and height as needed
}
...
// if (!empty($profile_picture) && file_exists($profile_picture)) {
//     $pdf->Image($profile_picture, 160, 10, 30, 0); // Adjust x, y, width, and height as needed
// }
...
$pdf->Cell(40, 10, 'Registration number:', 0, 0);
...
$pdf->SetFont('Arial', 'B', 11);
$pdf->Cell(45, 15, 'School/ College Fees:', 0, 0);
$pdf->SetFont('Arial', '', 13);
$pdf->Cell(40, 10, $School_College_Fees, 'B', 0); 

$pdf->SetFont('Arial', 'B', 11);
$pdf->Cell(10, 10, '', 0, 0);
$pdf->Cell(45, 15, 'Other Amount Payable:', 0, 0);
$pdf->SetFont('Arial', '', 13);
$pdf->Cell(40, 10, $Other_Amount_Payable_To_College, 'B', 1); 
...
$pdf->SetFont('Arial', 'B', 11);
// $pdf->Cell(90, 90, '', 0, 0);
$pdf->Cell(45, 8, 'Employer Name:', 0, 0);
$pdf->SetFont('Arial', '', 13);
$pdf->Cell(40, 8, $owner_name1, 'B', 0); 

$pdf->SetFont('Arial', 'B', 11);
$pdf->Cell(10, 10, '', 0, 0);
$pdf->Cell(45, 8, 'Employer contact :', 0, 0);
$pdf->SetFont('Arial', '', 13);
$pdf->Cell(40, 8, $owner_contact1, 'B', 1); 
...
$pdf->Cell(45, 8, 'Employer Name:', 0, 0);
$pdf->SetFont('Arial', '', 13);
$pdf->Cell(40, 8, $owner_name2, 'B', 0); 

$pdf->SetFont('Arial', 'B', 11);
$pdf->Cell(10, 10, '', 0, 0);
$pdf->Cell(45, 8, 'Employer contact :', 0, 0);
$pdf->SetFont('Arial', '', 13);
$pdf->Cell(40, 8, $owner_contact2, 'B', 1); 
...
$pdf->Cell(45, 8, 'Employer Name:', 0, 0);
$pdf->SetFont('Arial', '', 13);
$pdf->Cell(40, 8, $owner_name3, 'B', 0); 

$pdf->SetFont('Arial', 'B', 11);
$pdf->Cell(10, 10, '', 0, 0);
$pdf->Cell(45, 8, 'Employer contact :', 0, 0);
$pdf->SetFont('Arial', '', 13);
$pdf->Cell(40, 8, $owner_contact3, 'B', 1); 
